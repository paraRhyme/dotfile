...
GEOMETRY_COLOR_PROMPT=${GEOMETRY_COLOR_PROMPT:-green}
GEOMETRY_COLOR_ROOT=${GEOMETRY_COLOR_ROOT:-green}
...
prompt_geometry_render_lprompt() {
  echo "%B$GEOMETRY_PROMPT_PREFIX%${#PROMPT_SYMBOL}{%(?.$GEOMETRY_PROMPT.$GEOMETRY_EXIT_VALUE)%}%${#PROMPT_SYMBOL}{%(?.$GEOMETRY_PROMPT.$GEOMETRY_EXIT_VALUE)%}%${#PROMPT_SYMBOL}{%(?.$GEOMETRY_PROMPT.$GEOMETRY_EXIT_VALUE)%} %F{white}火:%f%b $GEOMETRY_PROMPT_SUFFIX"
}
...
prompt_geometry_render() {
  ...
  PROMPT2="  %F{yellow}$GEOMETRY_SYMBOL_RPROMPT%f   %B:%b "
